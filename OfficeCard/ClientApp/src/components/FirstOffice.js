...
export class FirstOffice extends Component {
    static displayName = FirstOffice.name;
    ...
    render() {
        return (
            <div>
                ...
                <p align="center"><b><b><h4>161 кв.м. 240 000 в месяц</h4></b></b></p>
                ...
                <div class="item-view-block">
                    <div class="item-params">
                        <ul class="item-params-list">
                            ...
                            <li class="item-params-list-item">
                                <span class="item-params-label">Обеспечительный платеж:</span> 240 000 ₽
                            </li>
                            <li class="item-params-list-item">
